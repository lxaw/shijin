...
class MultiHeadAttention(nn.Module):
    ...
    """
    def __init__(self,n_heads,head_size,block_size,dropout,n_embd):
        super().__init__()
        self.heads = nn.ModuleList([SelfAttentionHead(head_size=head_size,block_size=block_size,dropout=dropout,n_embd=n_embd) for _ in range(n_heads)])
...
class Block(nn.Module):
    ...
    def __init__(self,n_embd,head_size,n_heads,block_size,dropout):
        ...
        self.self_attention = MultiHeadAttention(n_heads=n_heads,head_size=head_size,
...
class GPT(nn.Module):
    def __init__(self,vocab_size,n_embd,block_size,n_heads,head_size,dropout,device):
        super().__init__()
        self.device = device
        ...
        self.blocks = nn.Sequential(
            *[Block(n_embd=n_embd,n_heads =n_heads,head_size=head_size,block_size=block_size,dropout=dropout)]
        )
